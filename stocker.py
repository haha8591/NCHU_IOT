...
#==============================================================================#
    ...
    def changepoint_prior_analysis(self, changepoint_priors=[0.001, 0.05, 0.1, 0.2], colors=['b', 'r', 'grey', 'gold'], chart_name=''):
        ...
        plt.savefig('D:\\Desktop\\NCHU_IOT-main\\Stock_final\\static\img\\long_short_'+ chart_name +'.png')
        #plt.show()
            
    # Basic prophet model for specified number of days  
    def create_prophet_model(self, days=0, resample=False, chart_name=''):
        ...
        plt.title(title)
        plt.savefig('D:\\Desktop\\NCHU_IOT-main\\Stock_final\\static\img\\7day_pre_'+ chart_name +'.png')
        #plt.show()
        
        return model, future
      
    # Evaluate prediction model for one year
    def evaluate_prediction(self, start_date=None, end_date=None, nshares = None, chart_name=''):
        ...
        if not nshares:
            ...
            # Plot the uncertainty interval as ribbon
            ax.fill_between(future['ds'].dt.to_pydatetime(), future['yhat_upper'], future['yhat_lower'], alpha = 0.6,facecolor = 'gold', edgecolor = 'k', linewidth = 1.4, label = 'Confidence Interval')
